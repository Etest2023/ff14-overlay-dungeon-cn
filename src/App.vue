    ...
    <main>
        ...
        <section v-if="currentEnemy">
            ...
            <ul class="Weakness" v-if="!currentEnemyIsBoss">
                ...
                <li
                    class="icon slow"
                    :class="{ valid: currentEnemy.Weakness.Slow }"
                ></li>
                <li
                    class="icon heavy"
                    :class="{ valid: currentEnemy.Weakness.Heavy }"
                ></li>
                <li
                    class="icon bind"
                    :class="{ valid: currentEnemy.Weakness.Bind }"
                ></li>
                <li
                    class="icon sleep"
...
.stun
    background-image url('data:image/png;base64,')
    &.valid
...
.slow
    background-image url('data:image/png;base64,')
    &.valid
...
.heavy
    background-image url('data:image/png;base64,')
    &.valid
...
.bind
    background-image url('data:image/png;base64,')
    &.valid
...
.sleep
    background-image url('data:image/png;base64,')
    &.valid
